 ...
 * publicity.
 */
public class ObscuredSharedPreferences extends BaseObscuredSharedPreferences {

	public ObscuredSharedPreferences(Context context, String key, String fileName) {
		super(context, key, fileName);
	...
	public class Editor implements SharedPreferences.Editor {
		...
		@Override public Editor remove(String s) {
			delegate.remove(s);
			return this;
		}
	}
